...
export const metadata: Metadata = {
  title: 'Contact Us - AI Text Behind Image',
  description: 'Get in touch with us for support, questions, or feedback about our AI image processing service.',
}
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-lg shadow-xl p-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@aitextbehindimage.com</p>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <h2 className="text-2xl font-semibold text-gray-900 mb-6 text-center">Why Contact Us?</h2>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-600">Get help with using our AI tools and troubleshooting issues</p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">Discuss business opportunities and collaboration</p>
              </div>
            </div>
          </div>
        </div>
